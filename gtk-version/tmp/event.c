...
{ 
  ...
  if (strcmp(cmd, "kp") == 0 || strcmp(cmd, "kill_plot") == 0)
      ...
      else
	{
	  ...
	  set_cmd_prompt("Window Number: ");
	  ui_globals.action = SET_ACTIVE_WINDOW;
	}
    }
      ...
      else
	{
	  ...
	  set_cmd_prompt("Plot Number: ");
	  ui_globals.action = SET_ACTIVE_PLOT;
	}
    }
     ...
     char arg[256];
{
  ...
  switch(ui_globals.action)
    ...
    case SIMP_FUNC_GET_MAX_ITER:
      ...
      ui_globals.action = SIMP_FUNC_GET_INIT_GUESSES;
      break;
    ...
    case SIMP_FUNC_GET_INIT_GUESSES:
      ...
      ui_globals.action = SIMP_FUNC_GET_INIT_STEP_SIZE;
      break;
...
/*fprintf(stderr,"in event.c at#200\n");*/
      ...
      else
	{
	  if (nargs > 5) 
	  {
	  	...
	  	sprintf(tmp_cmd, "median_smooth %s ", arg);
	  	name_col(getcol(tmp_cmd, 3));
	  	ui_globals.action = MEDIAN_SMOOTH_NAME;
	  }
	  else 
	  	ui_globals.action = MEDIAN_SMOOTH_NAME;
	}
      ...
      else
	{
	  ...
	  sprintf(tmp_cmd, "scchisqr %s ", arg);
	  name_col(getcol(tmp_cmd, 3));
	  ui_globals.action = SCCHISQR_NAME;
	}
      ...
      else
	{
	  if (nargs > 5)
	    ...
	    { 
	      ...
	      set_cmd_prompt("First, Last: ");
	      ui_globals.action = DERIV_GET_INT;
	    }
	}
      break;
   ...
   case RGT:
      ...
      else if (nargs == 5)
	{
	  ...
	  set_cmd_prompt("k : ");	  
	  ui_globals.action = EC_GET_F;
	}      
      else 
	{
	  if (nargs > 3) stripper(arg, 3);
	  sprintf(tmp_cmd, "ec %s, ", arg);
	  ui_globals.action = EC_GET_INT;
	  set_left_footer("Type the first and last record for the interval");
	  set_cmd_prompt("First, Last: ");
	}
      break;
    ...
    case POLYFIT:
      ...
      ui_globals.action = POLYFIT_GET_INT;
      set_left_footer("Type the first and last record for the interval");
    ...
    case POLYFIT_GET_INT:
      if (nargs > 2) stripper(arg, 2);
      strcat(tmp_cmd, arg);
      ui_globals.action = POLYFIT_GET_INC;
      ...
      if (arg[0] == 'y' || arg[0] == 'Y')
	{
	  ...
	  set_cmd_prompt("Row #: ");
	  ui_globals.action = POLYFIT_I_GET_ROW;
	}
      else
	{
	  strcat(tmp_cmd, ", ");
	  ...
	  strcat(tmp_cmd, " 0 ");	  
          name_col(getcol(tmp_cmd, 4));
	  ui_globals.action = POLYFIT_NAME;
	}
      break;
    ...
    case POLYFIT_I:
      ...
      ui_globals.action = POLYFIT_I_GET_INT;
      set_left_footer("Type the first and last record for the interval");
      set_cmd_prompt("First, Last: ");
      break;
    ...
    case POLYFIT_I_GET_INT:
      if (nargs > 2) stripper(arg, 2);
      strcat(tmp_cmd, arg);
      ui_globals.action = POLYFIT_I_GET_INC;
    ...
    case INTERPOLATE_R:
      ...
      ui_globals.action = INTERPOLATE_GET_F_L;
      set_left_footer("Type the first and last record for the interval");
      set_cmd_prompt("First, Last: ");
      break;
    ...
    case INTERPOLATE_GET_F_L:
      ...
      strcat(tmp_cmd, arg);
      strcat(tmp_cmd, " ");
      ui_globals.action = INTERPOLATE_GET_INC;
    ...
    case INTERPOLATE_GET_INC:
      ...
      strcat(tmp_cmd, " ");
      name_col(getcol(tmp_cmd, 4));
      ui_globals.action = INTERPOLATE_NAME1;
      break; 
    ...
    case INTERPOLATE_NAME1:
      ...
      strcat(tmp_cmd, " ");
      name_col(getcol(tmp_cmd, 5));
      ui_globals.action = INTERPOLATE_NAME2;
      break;
    ...
    case MATHINT_F_L:
      ...
      ui_globals.action = MATHINT_NAME;
      break; 
      ...
      else
	{
	  ...
	  sprintf(tmp_cmd, "positive %s ", arg);
	  name_col(getcol(tmp_cmd, 3));
	  ui_globals.action = POSITIVE_NAME;
	}
      ...
      else
	{
	  ...
	  sprintf(tmp_cmd, "compress %s ", arg);
	  name_col(getcol(tmp_cmd, 3));
	  ui_globals.action = COMPRESS_NAME;
	}
    ...
    case R_TREND:
      ...
      ui_globals.action = R_TREND_TYPE;
      break;
      ...
      if (strncmp(arg, "input", 5) == 0 || strncmp(arg, "i", 1) == 0)
	{
	  ...
	  ui_globals.action = R_TREND_INPUT;
	}
      else
	{
	  ...
	  set_cmd_prompt("X-col Y-col New-col: ");
	  ui_globals.action = R_TREND_COMP;
	}
      break;
    ...
    case R_TREND_INPUT:
      ...
      strcat(tmp_cmd, " ");
      name_col(getcol(tmp_cmd, 6));
      ui_globals.action = R_TREND_INPUT_NAME;
      break;
    ...
    case R_TREND_COMP:
      ...
      set_cmd_prompt("First Last: ");
      ui_globals.action = R_TREND_COMP_FL;
      break;
    ...
    case R_TREND_COMP_FL:
      ...
      strcat(tmp_cmd, " ");
      name_col(getcol(tmp_cmd, 6));
      ui_globals.action = R_TREND_COMP_NAME;
      break;
      ...
      else
	{
	  ...
	  sprintf(tmp_cmd, "summation %s ", arg);
	  name_col(getcol(tmp_cmd, 3));
	  ui_globals.action = SUMMATION_NAME;
	}
    ...
    case DECIMAT_F_L:
      ...
      strcat(tmp_cmd, " ");
      name_col(getcol(tmp_cmd, 3));
      ui_globals.action = DECIMAT_NAME;
      break; 
    ...
    case R_ROW_COL:
      ...
      set_left_footer("Type the first and last row to remove");
      set_cmd_prompt("First, Last: ");
      ui_globals.action = R_ROW_COL_F_L;
      break;
	...
	/*  if (nargs > 3)
	  ...
	  set_cmd_prompt("y/n: ");
	  ui_globals.action = OFFSET_INT_GET_YN;
	}
	...
	stripper(arg, 1);
      ...
      set_cmd_prompt("First, Last: ");
      ui_globals.action = SIMPLEX_GET_F_L;
      break;
	...
	stripper(arg, 2);
      ...
      set_cmd_prompt("X-col, Y-col: ");
      ui_globals.action = SIMPLEX_GET_COLS;
      break;
	...
	ui_globals.action = PLOT_SCALE;
      else
	ui_globals.action = PLOT_OTHERS;
      break;
